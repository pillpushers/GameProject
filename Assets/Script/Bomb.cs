	...
	public void Explode()
	{
		...
		foreach(Collider2D en in enemies)
		{
			...
			if(rb != null && rb.tag == "Enemy")
			{
				...
				Enemy enem = rb.gameObject.GetComponent<Enemy>();
				if (enem != null){
					...
					Enemy_2 enem2 =  rb.gameObject.GetComponent<Enemy_2>();
					enem2.Death();
				}
		...
		GameObject explor =  Instantiate(explosion,transform.position, Quaternion.identity);
		Destroy(explor, 0.5f);
